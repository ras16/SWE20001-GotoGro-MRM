...
<head>
	...
	<title>Members Listing - Gotogro</title>
			...
			<div class="modal-content">
				<div>
					...
					<div class="modal-footer">
						...
						<input type="submit" class="btn btn-success" onclick="go_add_user()" value="Add">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div>
					...
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
						<input type="submit" class="btn btn-success" value="Modify" onclick="go_modify()">
					</div>
				</div>
			</div>
		</div>
